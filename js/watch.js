...
window.onload = function info(){
    ...
    document.getElementById("titlea").textContent = movies[1].name;
    document.getElementById("datea").textContent = movies[1].year;
    document.getElementById("imdba").textContent = movies[1].IMDBrate;
    document.getElementById("usera").textContent = movies[1].userrate;
    /*document.getElementById("poster").textContent = movies[9].image;*/
    
    
    document.getElementById("titleb").textContent = series[0].name;
    document.getElementById("dateb").textContent = series[0].year;
    document.getElementById("imdbb").textContent = movies[0].IMDBrate;
    document.getElementById("userb").textContent = movies[0].userrate;
    /*document.getElementById("poster").textContent = movies[9].image;*/
    
    
    document.getElementById("titlec").textContent = cartoons[1].name;
    document.getElementById("datec").textContent = cartoons[1].year;
    document.getElementById("imdbc").textContent = movies[1].IMDBrate;
    document.getElementById("userc").textContent = movies[1].userrate;
    /*document.getElementById("poster").textContent = movies[9].image;*/
    
    
    document.getElementById("titled").textContent = movies[3].name;
    document.getElementById("dated").textContent = movies[3].year;
    document.getElementById("imdbd").textContent = movies[3].IMDBrate;
    document.getElementById("userd").textContent = movies[3].userrate;
    /*document.getElementById("poster").textContent = movies[9].image;*/
