...
/*$(document).ready(function() {
    ...
    $("img").attr("src", "img/at.jpg");
    $("img").attr("src", "img/fg.jpg");
    $("img").attr("src", "img/bb.jpg");
    $("img").attr("src", "img/ave.jpg");
    $("img").attr("src", "img/ava.jpg");
    $("img").attr("src", "img/70.jpg");
    $("img").attr("src", "img/ctcd.jpg");
    $("img").attr("src", "img/mom.jpg");
    $("img").attr("src", "img/fgp.jpg");
    $("img").attr("src", "img/pf.jpg");
    $("img").attr("src", "img/et.jpg");
